---
name: harness_promotion
description: Promote an installed harness CLI release from detected or best-effort to the engine's maintained tested baseline. Use when the FnB asks to qualify and publish support for a newer Claude, Codex, OpenCode, Vibe, Kimi, or DeepSeek runtime. Do not use for ordinary model discovery.
category: craft
common: false
---
