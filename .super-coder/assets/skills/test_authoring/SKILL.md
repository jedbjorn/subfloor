---
name: test_authoring
description: Principles for stringent pytest tests — tests that can actually fail. Pair with test_authoring_sqlite or test_authoring_pg for stack-specific infra context.
category: craft
common: false
---
