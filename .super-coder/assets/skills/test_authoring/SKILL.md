---
name: test_authoring
description: Standards for writing and reviewing stringent pytest tests — tests that can actually fail. Use when authoring or reviewing any test under `tests/`.
category: craft
common: false
---
