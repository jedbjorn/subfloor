---
name: snapshot
description: Persist DB work to git-tracked text — when and how to run ./sc snapshot / ./sc render before committing. The .db is a cache; text is the source of truth.
category: substrate
command: ./sc snapshot
common: true
---
