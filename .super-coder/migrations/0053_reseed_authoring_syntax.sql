-- 0053 — reseed: full catalogue rewrite to authoring_syntax house style
--
-- Every engine skill body (and description where tightened) was rewritten to
-- the authoring_syntax standard: directives with success conditions, specific
-- prohibitions, light operators, need-to-know. Content preserved; syntax
-- converted. Boot docs untouched.
--
-- Installed forks never re-run 0001, and prior seeds + reseeds (0040-0052, incl. 0052_sprint_skills) run
-- after 0001 on a fresh build, carrying pre-rewrite bodies for
-- their skills. This trailing forward reseed (UPSERT by name; skill_id +
-- grants preserved) carries the rewritten catalogue to installed forks and
-- fresh builds alike.
