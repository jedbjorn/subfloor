-- 0155 — publish the surviving generic test doctrine and PG diagnostics.
--
-- Full-body UPSERTs converge existing installations after the three
-- obsolete testing/engine assets leave the generated active seed.
