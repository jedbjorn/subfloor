...
#   make dos-l   / dos-launch    start the host review server + GUI (bare metal)
...
dos-help:
	...
	@echo "    dos-l / dos-launch          start the host review server + GUI (bare metal)"
	@echo "    dos-r / dos-restart         DB backup + restart host services (ARGS forwarded)"
	@echo "    dos-d / dos-down            stop the host services"
	...
	@echo ""
	@echo "  MAINTENANCE"
	@echo "    dos-build                   (re)build the optional sandbox container image"
	@echo "    dos-logs                    tail the host review-server log"
