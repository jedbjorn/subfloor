...
dos-help:
	...
	@echo "    dos-ports                   print this fork's api + dev-server port numbers"
	...
	@echo "    dos-snapshot                serialize the per-instance tables to content.sql"
	@echo "    dos-deps                    install python (.venv) + node deps + the dev kit"
	@echo "    dos-setup / dos-install     first-launch bootstrap: reqs, harness, first shell"
	@echo "    dos-rollback                undo a bad update — restore the DB + engine together"
